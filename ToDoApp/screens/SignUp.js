import { Text, View, TextInput, ImageBackground, Button, Platform, KeyboardAvoidingView } from 'react-native';
  ...
  return (
    <ImageBackground style={AppStyles.imageContainer} source={background}>
      ...
      <KeyboardAvoidingView 
        ...
        value={password}
        onChangeText={(value) => validateAndSet(value, setConfirmPassword, setPassword)} />
